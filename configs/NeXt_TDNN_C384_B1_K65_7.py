...
# 😀😀 for test 
TEST_CHECKPOINT = './experiments/T2_12_TS_ConvNeXt_TDNN_C384_B1_K65_7/lightning_logs/version_0/checkpoints/s-epoch=127-loss=2.14-full_minimum=1.10-min_eer_seg=1.99.ckpt'
