...
# 😀😀 for test 
TEST_CHECKPOINT = './experiments/T1_06_TS_ConvNeXt_TDNN_Light_C256_B3_K65/lightning_logs/version_0/checkpoints/s-epoch=103-loss=1.73-full_minimum=0.91-min_eer_seg=1.83.ckpt'
