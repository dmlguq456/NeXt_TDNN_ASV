# Original file name: './exp_compet_msc_tune/idx258_c512_02_TS_ConvNeXt_WI_GRN_1_branch_2_MSDC_256_3_k65_7_cleaned_scrat_2nd'
...
# ?? 5. LightningModule
TRAINER_CONFIG = {
    'default_root_dir': './experiments/NeXt_TDNN_C256_B3_K65_7',
...
# 😀😀 for test 
TEST_CHECKPOINT = './experiments/T1_08_TS_ConvNeXt_TDNN_S2_C256_B3_K65_7/lightning_logs/version_0/checkpoints/s-epoch=63-loss=1.73-full_minimum=0.91-min_eer_seg=1.74.ckpt'
