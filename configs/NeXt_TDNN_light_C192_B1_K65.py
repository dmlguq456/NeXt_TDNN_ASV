...
# 😀😀 for test 
TEST_CHECKPOINT = './experiments/T2_04_TS_ConvNeXt_TDNN_Light_C192_B1_K65/lightning_logs/version_0/checkpoints/s-epoch=194-loss=3.82-full_minimum=1.55-min_eer_seg=2.59.ckpt'
