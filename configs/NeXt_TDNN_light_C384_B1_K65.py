...
# 😀😀 for test 
TEST_CHECKPOINT = './experiments/T2_10_TS_ConvNeXt_TDNN_Light_C384_B1_K65/lightning_logs/version_0/checkpoints/s-epoch=173-loss=2.38-full_minimum=1.19-min_eer_seg=2.09.ckpt'
